...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            type='PETRTransformerV2',
            decoder=dict(
                type='PETRTransformerDecoderV2',
                return_intermediate=True,
                num_layers=6,
                transformerlayers=dict(
                    type='PETRTransformerDecoderLayerV2',
                    attn_cfgs=[
                        dict(
...
db_sampler = dict(
    data_root=data_root,
    info_path=data_root + 'mmdet3d_nuscenes_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
total_epochs = 24
evaluation = dict(interval=1, start=15, pipeline=test_pipeline)
