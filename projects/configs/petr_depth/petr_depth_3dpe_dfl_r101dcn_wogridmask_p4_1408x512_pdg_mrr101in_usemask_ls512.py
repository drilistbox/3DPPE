...
pretrained = "https://download.openmmlab.com/pretrain/third_party/resnet101_msra-6cc46731.pth"
model = dict(
    type='Petr3D_Depth',
    use_grid_mask=True,
    img_backbone=dict(
...
load_from='ckpts/mask_rcnn_r101_in/mask_rcnn_r101_fpn_1x_nuim_20201024_134803-65c7623a.pth'
resume_from=None
