...
pretrained = "https://download.openmmlab.com/pretrain/third_party/resnet50_msra-5891d200.pth"
model = dict(
    type='Petr3D_Depth',
    use_grid_mask=False,
    img_backbone=dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_depth=dict(type='SmoothL1Loss', beta=1.0 / 9.0, reduction='mean', loss_weight=0.1),
...
db_sampler = dict(
    ...
    info_path=data_root + 'petr/mmdet3d_nuscenes_30f_infos_train.pkl',
    rate=1.0,
    prepare=dict(
...
data = dict(
    ...
    test=dict(type=dataset_type, 
              data_root=data_root,
              ann_file=data_root + 'petr/mmdet3d_nuscenes_30f_infos_test.pkl',
              pipeline=test_pipeline, classes=class_names, modality=input_modality))
...
load_from='ckpts/mask_rcnn_r50_inandcoco/mask_rcnn_r50_fpn_coco-2x_1x_nuim_20201008_195238-b1742a60.pth'
resume_from=None
