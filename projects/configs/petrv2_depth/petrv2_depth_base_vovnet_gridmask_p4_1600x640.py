...
data = dict(
    ...
    test=dict(type=dataset_type, pipeline=test_pipeline, ann_file=data_root + 'petr/mmdet3d_nuscenes_30f_infos_val.pkl', classes=class_names, modality=input_modality))
