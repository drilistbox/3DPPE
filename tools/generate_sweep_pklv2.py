...
info_path = os.path.join(data_root, 'petr', 'mmdet3d_nuscenes_30f_infos_{}.pkl'.format(info_prefix))
key_infos = pickle.load(open(os.path.join(data_root, 'mmdet3d_nuscenes_infos_{}.pkl'.format(info_prefix)), 'rb'))
if info_prefix == 'test':
